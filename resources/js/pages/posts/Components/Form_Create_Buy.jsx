...
const FORM_FIELD = [
    {slug: 'nha-dat-can-ban', title: 'Nhà đất cần bán'},
    {slug: 'nha-dat-can-thue', title: 'Nhà đất cần thuê'}
]
class Form_Create_Buy extends Component {
    constructor (props) {
        super(props)
            ...
            <div>
                ...
                <div className="row">
                    <div className="col col-sm-12 col-md-6">
                        ...
                        <input type="date" className="form-control datepicker" name="from_date" id="from_date" />
                    </div>
                    <div className="col col-sm-12 col-md-6">
                        <label htmlFor="">Ngày kết thúc</label>
                        <input type="date" className="form-control datepicker" name="to_date" id="to_date" />
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col col-sm-12">
                        <label htmlFor="content">Nội dung tin đăng <span className="text-danger">(*)</span></label>
                        <textarea rows="3" className="form-control" id="content"></textarea>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col col-sm-12 col-md-6">
                        ...
                        <input type="text" className="form-control mr-3" name="address"/>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col col-sm-12 col-md-7">
                        ...
                        <input type="text" className="form-control mr-3" name="address_contact"/>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col col-sm-12 col-md-7">
                        ...
                        <input type="text" className="form-control mr-3" name="phone"/>
                    </div>
                </div>

                <div className="row">
                    <div className="col col-sm-12 col-md-7">
                        <label htmlFor="">Di động <span className="text-danger">(*)</span></label>
                        <input type="text" className="form-control mr-3" name="mobile"/>
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col col-sm-12 col-md-7">
                        ...
                        <input type="email" className="form-control mr-3" name="email"/>
                    </div>
                </div>
...
export default Form_Create_Buy
